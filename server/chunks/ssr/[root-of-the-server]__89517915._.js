...
"[project]/lib/supabaseBrowserClient.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PostPage() {
    ...
    const [posterEmail, setPosterEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from('jobs').select('*').eq('poster_email', email).order('created_at', {
                ascending: false
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89517915._.js.map