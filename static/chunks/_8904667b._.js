...
function LoginPage() {
    ...
    const handleEmailSubmit = async (e)=>{
        ...
        const { data: sessionData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.getSession();
        if (sessionData.session) {
            setMessage('✅ Already logged in. Redirecting...');
            router.replace('/');
            return;
        }
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.signUp({
            email,
            password: 'placeholder123'
        });
        if (error?.message?.includes('User already registered')) {
            setStep('login');
            setMessage('✅ Account found. Please enter your password.');
        } else if (!error) {
            // User doesn't exist, send them a magic link to set password
            const { error: otpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.signInWithOtp({
                email,
                options: {
            ...
            if (otpError) {
                setMessage('❌ Error: ' + otpError.message);
            } else {
                setMessage('✅ Check your email to confirm and set your password.');
                setStep('email');
            }
            // 🔐 clear any temp session created from the signUp probe
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.signOut();
        } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            step === 'login' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                onSubmit: async (e)=>{
                    e.preventDefault();
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.signInWithPassword({
                        email,
                        password
                    });
                    if (error) {
...
_s(LoginPage, "hEeTdwfSf6Rw9ZyCg1i6n8EH/bc=", false, function() {
    return [
