...
function PostPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PostPage.useEffect": ()=>{
            const check = {
                "PostPage.useEffect.check": async ()=>{
            ...
            }["PostPage.useEffect.check"];
            check();
        }
    }["PostPage.useEffect"], []);
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const { data: { user }, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.getUser();
        if (userError || !user) {
            setMessage('You must be logged in to post.');
            return;
        }
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseBrowserClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('requests').insert([
            {
                title,
                description,
                paid,
...
_s(PostPage, "Vpp3QzktFhYp/qjDcO2/uqTKcz8=", false, function() {
    return [
...
//# sourceMappingURL=_59a427b1._.js.map